...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen px-10 font-["Test Founders Grotesk X_Cond SmBd"]'>
        <div className="w-1/2 h-full flex flex-col justify-between">
            <div className="heading ">
                <h1 className=' px-8 text-[6vw] leading-none uppercase tracking-tighter font-bold -mb-4'>EYE-</h1>
                <h1 className=' px-8 text-[6vw] leading-none uppercase tracking-tighter font-bold -mb-4'>opening</h1>
            </div>
            <svg className='mb-24 ml-12' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h1 className=' text-[5vw] leading-none uppercase tracking-tighter font-bold -mb-4'>Presentations</h1>
        <div className="dets font-['Neue Montreal'] mt-20 flex flex-col gap-16 block text-xl underline">
            <div>
            ...
            <div>
									<span class="link link--underline">202-1965 W 4th Ave</span><br />
                <span class="link link--underline">Vancouver, Canada</span><br />
                <span class="link link--underline"> </span><br />
                <span class="link link--underline">30 Chukarina St</span><br />
                <span class="link link--underline">Lviv, Ukraine</span><br />							
            </div>
            <div>
